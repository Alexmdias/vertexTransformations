...
var controller = {type: 'v3', value: new THREE.Vector3(0,0,0)};
...
function checkKeyboard() {
	...
	controller.value.x = remotePosition0.value.y;
	controller.value.y = remotePosition1.value.y;
	controller.value.z = remotePosition2.value.y;
